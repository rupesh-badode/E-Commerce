...
export default function Shop(){
    ...
    function AddtoCartClick(e){
        axios.get(`https://fakestoreapi.com/products/${e.currentTarget.name}`)
        .then(res=>{
          addToCart(res.data);
          setShowAlert(true);
          setTimeout(() => {
    ...
    <div>
      ...
      <div className="row">
        <div className="col-12 col-sm-3 col-md-2">
            <Menu onCategoryChange={(category)=>setCategory(category)} onSortChange={(sortOrder)=>setsortOrder(sortOrder)}/>
        </div>
        <div className="col-12 col-sm-9 col-md-10">
            <motion.div className="row shadow rounded justify-content-center"  initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration:1 }} >
                    ...
                    Array.from({ length: 8 }).map((_, index) => (
                      ...
                      <div key={product.id} className="card col-12 col-sm-6 col-md-4 col-lg-3 m-3" draggable onDragStart={(e)=>e.dataTransfer.setData("product",JSON.stringify(product))}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="fw-bold"><span>&#8377;</span>{product.price}</div>
                        </div>
                        <div className="card-footer">
                            <button className="btn btn-primary me-1" name={product.id} onClick={AddtoCartClick} >Add to Cart</button>
                            <button className="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#Quicklook" onClick={()=>setSelectedProduct(product)}><span className="bi bi-eye" ></span></button>
                        </div>
                      </div>
                    ))
                  )}
      ...
      <div>
        {selectedProduct && (
        <div className="modal fade" id="Quicklook" tabIndex="-1">
            ...
            <div className="modal-content">
              ...
              <div className="modal-body d-flex flex-wrap">
                ...
                <div className="col-md-7 px-4">
                  ...
                  <div className="fw-bold text-success h5 mb-3">
